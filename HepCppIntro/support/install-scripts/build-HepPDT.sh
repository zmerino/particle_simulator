...
#
# W. H. Bell
# A bash script to download and build HepPDT
#
version=3.03.02

base_dir=${PWD%/install-scripts}
tmp_dir=$base_dir"/tmp-HepPDT"

source_file="HepPDT-"$version".tar.gz"
source_dir="HepPDT-"$version

download_url="http://lcgapp.cern.ch/project/simu/HepPDT/download/"
...
echo "./configure --prefix=$base_dir"
